...
export const AssessmentResults: React.FC = () => {
  ...
  console.log('Parsed state:', { predictions, insights, responses });

  if (!predictions || !insights || !responses) {
    console.error('Missing data in state:', {
  ...
  console.log('Received results data:', { predictions, insights, responses });
  
  return (
    <div className="min-h-screen bg-gray-50 p-8" data-testid="assessment-results">
      ...
      <div className="max-w-4xl mx-auto bg-white p-8 rounded-lg shadow-lg">
        ...
        {predictions.length > 0 && (
          <div className="mb-8">
            <h2 className="text-2xl font-semibold mb-4">Top Career Suggestions</h2>
        ...
        {ai_analysis && (
          <div className="mb-8">
            ...
            <div className="space-y-4">
              {ai_analysis?.classifications.map((classification: { confidence: number; input: string; label: string }, index: number) => (

                <div key={index} className="bg-gray-50 p-4 rounded-lg">
                  <p className="text-gray-600 mb-2">{classification.input}</p>
                  <div className="bg-gray-100 rounded-full h-2.5">
                    <div
